...
books = pd.read_csv("D:\\courses\\01 - Học code\\24 - Data mining\\Data Mining Book Store\\Book-recommender-system\\Django\\BookRack\\home\\book_data2.csv",engine="python")
